...
In general, one should avoid having too-similar commands.

h2. Help and Documentation

* Most user interfaces have sufficiently many features to warrant a manual and possibly a help system
* Regular users of a system may want documentation to enable them to acquire higher levels of expertise
* "It's explained in the manual" should not be a designer's excuse if a user cannot understand how to use the system

h3. A Model of Documentation Use

1. _Searching_: Locate information relevant to a specific need
2. _Understanding_ the information
3. _Applying_: Carry out a procedure as described in the documentation

Two main search tools are the index and the overview map of the structure of the information space. Contemporaneously it is more likely the search facility.

A "minimal manual" may also be provided to give information that is absolutely necessary for the user to get started.
